...
- The README is now written for people using the app, with screenshots,
  install instructions, and a walkthrough of every feature. Build
  instructions and internal architecture notes moved to `BUILDING.md`.
